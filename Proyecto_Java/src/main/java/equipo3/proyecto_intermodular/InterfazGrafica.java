...
public class InterfazGrafica extends javax.swing.JFrame {
    ...
    private void cargarTipoCuenta() {
        ...
        cmbTipoCuenta.addItem("Personal");
    }
        ...
        try {
            ...
            if (cantidadMax > 0) {
                ...
                if (cantidadMax >= 5000) {
                    ...
                    jComboBoxPrestamos.addItem("Prestamo Pequenio : 5000€ con tipo de interes de 10%");

                    if (cantidadMax >= 10000) {
                        jComboBoxPrestamos.addItem("Prestamo Mediano : 10000€ con tipo de interes de 5%");
                        System.out.println("10000");
                        if (cantidadMax >= 15000) {
                            jComboBoxPrestamos.addItem("Prestamo Grande : 15000€ con tipo de interes de 3%");
    ...
    private void verClienteDetalleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_verClienteDetalleActionPerformed
        ...
        try {
            ...
            if (auxCliente != null) {
                ...
                //pongo el texto de conceder prestamos a un texto por defecto
                jTextFieldIdPreconcedido.setText("Inserta el id del preconcedido");
    ...
    private void ListarPrestamosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ListarPrestamosActionPerformed
        ...
        try {
            ...
            if (objAptos.length == 0 || objAptos == null) {
            ...
            if (objNoAptos.length == 0 || objNoAptos==null) {
